"""IP LIVE -- runtime probe of the TikTok hook on a phone.
...
# one produced by the LSPatch JAR IP LIVE has shipped since
...
# patches done outside IP LIVE, drift recovery from another PC).
_KNOWN_LSPATCH_FINGERPRINT_PREFIXES: tuple[str, ...] = (
    "e0b8d3e5",   # IP LIVE LSPatch keystore — verified at v1.7.4
)
